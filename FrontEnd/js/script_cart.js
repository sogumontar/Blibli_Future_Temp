...
$(document).ready(function(){
	...
	function test(){
		...
		$.ajax({
								 ...
								 $("#dat").
									...
									<div class="col-md-8">\
											<table>\
												...
												<tr>\
													<td><a onclick="hap('+users[i].id+')"><button class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus dari keranjang</button></a></td>\
												</tr>\
											</table>\
									</div>\
								</div><br>');
			...
			alert("You must be login to open cart");
