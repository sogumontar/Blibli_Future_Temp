               ...
               $("#listUser").
                append('<div class="col-md-12">\
                    <div class="row">\
                      ...
                      <div>\
                        ' + (users[i].status == 1 ? '<a href="temp.html?id='+users[i].id+'"><button type="button" class="btn btn-outline-danger" id="but_block"><img src="Pict/wrong.png" id="pict_button"> Block</button></a>': '<a href="temp.html?id='+users[i].id+'"><button type="button" class="btn btn-outline-primary" id="but_active"><img src="Pict/cek.png" id="pict_button"> Active</button></a>') + '\
                      </div>\
                    </div>\
                </div>\
                  ');
